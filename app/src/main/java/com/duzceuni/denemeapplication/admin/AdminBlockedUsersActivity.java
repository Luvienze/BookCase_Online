...
import com.duzceuni.denemeapplication.adapter.RvUsersBlockedAdaptor;
...
public class AdminBlockedUsersActivity extends AppCompatActivity {
    ...
    private RvUsersBlockedAdaptor adaptor;
    ...
    private void initComponents() {
        ...
        Query query = dbRef.orderByChild("banned").equalTo(true);
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                adaptor = new RvUsersBlockedAdaptor(AdminBlockedUsersActivity.this, users);
            ...
            public void onCancelled(DatabaseError error) {
                //Toast.makeText(AdminBlockedUsersActivity.this, "Veri alınamadı.", Toast.LENGTH_SHORT).show();
            }
        });
    }
    private void registerEventHandlers() {
        ...
        nv_slide.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                menuClass.logout(menuItem, AdminBlockedUsersActivity.this,sharedPref);
        ...
        ItemTouchHelper.SimpleCallback simpleCallback = new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT) {
            ...
            public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                if (direction == ItemTouchHelper.LEFT) {
                    ...
                    dbRef1.child(Id).child("banned").setValue(false);
                    adaptor.removeItem(position);
                    Toast.makeText(AdminBlockedUsersActivity.this,R.string.Toast_engel1,Toast.LENGTH_SHORT).show();
            ...
            public void onChildDraw(@NonNull Canvas c,
                ...
                if (dX > 0) { // sağa kaydırma
                    ...
                    Drawable icon = ContextCompat.getDrawable(AdminBlockedUsersActivity.this, R.drawable.ic_turnoff); // sil ikonu
    ...
    private void filterList(String text) {
        ...
        {
            adaptor = new RvUsersBlockedAdaptor(this,filteredList);
            rv.setAdapter(adaptor);
        }
    }
    public boolean onKeyDown(int keyCode, KeyEvent keyEvent) {   //geri tusuna basınca olacak
        switch (keyCode) {
            case KeyEvent.KEYCODE_BACK:
                Intent intent = new Intent(AdminBlockedUsersActivity.this, AdminHomeActivity.class);
